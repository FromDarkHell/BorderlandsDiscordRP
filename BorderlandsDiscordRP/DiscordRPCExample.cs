...
namespace BorderlandsDiscordRP
{
    class DiscordRPCExample
    {
        ...
        /// </summary>
        private static LogLevel DiscordLogLevel = LogLevel.Warning;
        ...
        //Main Loop
        private static void slain(string[] args)
        {
        ...
        static void BasicExample()
        {
            ...
            //Create the logger
            client.Logger = new ConsoleLogger() { Level = DiscordLogLevel, Coloured = true };
